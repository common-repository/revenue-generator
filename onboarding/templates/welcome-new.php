...
<div class="rev-gen-layout-wrapper">
	<section class="rev-gen-welcome">
		<section class="rev-gen-welcome__left">
			<h1 class="rev-gen-welcome__title"><?php esc_html_e( 'Welcome to', 'revenue-generator' ); ?><br>Revenue Generator 2.0</h1>
		...
		<section class="rev-gen-welcome__buttons">
			...
			<div class="rev-gen-welcome__buttons-wrap">
				<div id="rg_Contribution" class="rev-gen-card">
					<img class="rev-gen-card__icon" alt="<?php esc_attr_e( 'Create contribution icon', 'revenue-generator' ); ?>" src="<?php echo esc_url( REVENUE_GENERATOR_BUILD_URL . '/img/welcome-contribution.svg' ); ?>">
